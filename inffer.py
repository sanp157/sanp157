...
# 🔒 OPTIONAL AUTOTUNE (SAFE GUARD)
try:
    from rvc.lib.predictors.autotune import Autotune
except Exception:
    Autotune = None
...
class Pipeline:
    def __init__(self, tgt_sr, config):
        ...
        self.autotune = Autotune() if Autotune is not None else None
    ...
    def get_f0(
        ...
        # 🔒 SAFE AUTOTUNE (ONLY IF AVAILABLE)
        if f0_autotune and self.autotune is not None:
    ...
    def pipeline(
        ...
        # AUTHOR-SAFE: HuBERT gets UNPADDED audio
